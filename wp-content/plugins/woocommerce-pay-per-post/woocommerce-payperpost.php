		...
		class Woocommerce_PayPerPost {
			...
			public static function render($content) {
				...
				if ($has_access) {
					...
					return self::get_no_access_content();
				}
			...
			/**
			 * Can check to see if user has access to post
			 * @return bool
			 */
			...
			/**
			 * Return content from settings
			 * @return string
			 */
			public static function get_no_access_content(){
				$productID = self::get(self::METAKEY);
				return do_shortcode(str_replace('{{product_id}}', $productID, get_option('wcppp_oops_content')));
			}
